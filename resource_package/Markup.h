...
#if !defined(AFX_MARKUPSTL_H__948A2705_9E68_11D2_A0BF_00105A27C570__INCLoadBalanceUnitDED_)
#define AFX_MARKUPSTL_H__948A2705_9E68_11D2_A0BF_00105A27C570__INCLoadBalanceUnitDED_
...
public:
	...
	enum MarkupNodeType
	{
		...
		MNT_EXCLoadBalanceUnitDE_WHITESPACE		= 123,// 0x7b
	...
	bool AddElemEx(const char* szName, __int64 nValue, int nFlags = 0) { return x_AddElemEx(szName, nValue, nFlags); };
...
protected:
	...
	bool x_AddElemEx(const char* szName, __int64 nValue, int nFlags);
...
#endif // !defined(AFX_MARKUPSTL_H__948A2705_9E68_11D2_A0BF_00105A27C570__INCLoadBalanceUnitDED_)
